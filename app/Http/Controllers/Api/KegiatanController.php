...
{
    public function __construct(KegiatanServices $services)
    {
    ...
    public function dataTable()
    {
        ...
        $data = Kegiatan::query()
            ...
            ->select('kegiatan.*', 'program.kode_program', 'program.nama_program', 'bidang_urusan.kode_bidang_urusan', 'bidang_urusan.nama_bidang_urusan', 'urusan.kode_urusan', 'urusan.nama_urusan')
