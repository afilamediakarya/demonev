...
use App\Services\SasaranServices;
use Illuminate\Http\Request;
use Yajra\DataTables\DataTables;

class SasaranController extends ApiController
{
    public function __construct(SasaranServices $services)
    {
    ...
    public function dataTable()
    {
        ...
        $data =  Sasaran::join('tujuan','tujuan.id','=','sasaran.id_tujuan')
        ->select('sasaran.*','tujuan')->where('sasaran.id_unit_kerja',$id_unit_kerja)->get();
