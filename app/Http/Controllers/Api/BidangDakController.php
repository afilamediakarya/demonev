...
use App\Services\BidangDakService;
use Illuminate\Http\Request;
use Yajra\DataTables\DataTables;


class BidangDakController extends ApiController
{
    public function __construct(BidangDakService $services)
    {
