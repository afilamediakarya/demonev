...
class LaporanEvaluasiRenjaController extends Controller
{
    public function index()
    {
        ...
        if(!empty($unit_kerja_selected)){
            ...
            // return Str::slug( ($unit_kerja_selected ? ' index_dinas' : 'index'), '_');
    ...
    public function export_evaluasi_renja_semua($tipe, $data)
    {
        $spreadsheet = new Spreadsheet();
        $spreadsheet->getProperties()->setCreator('AFILA')
            ->setLastModifiedBy('AFILA')
        ...
        $sheet->setCellValue('A2', 'PEMDA DI KABUPATEN ' . strtoupper(optional($profile)->nama_daerah));
        ...
        // $sheet->getStyle('A1')->getFont()->setSize(12);
                ...
                $sheet->setCellValue('C5', 'Capaian Kinerja')->mergeCells('C5:D5');
                        $sheet->setCellValue('C6', '%')->getColumnDimension('C')->setWidth(30);
                ...
                $sheet->setCellValue('F6', '%')->getColumnDimension('F')->setWidth(30);
                $sheet->setCellValue('G6', 'Kategori')->getColumnDimension('G')->setWidth(30);
                $cell = 7;
