...
class RpjmdController extends Controller
{
    public function index()
    {
        ...
        return view('master_kegiatan/rpjmd',compact('jadwal_input'));
    }
    ...
    public function detail($uuid){
        ...
        return view('master_kegiatan/detail',compact('dpa'));
    }
    ...
    public function setOutput()
    {
        ...
        return view('master_kegiatan/atur_dpa', compact('jenis_belanja', 'sumber_dana', 'metode_pelaksanaan', 'satuan'));
    }
    ...
    public function edit($uuid)
    {
        ...
        $metode_pelaksanaan = MetodePelaksanaan::get();
        $satuan = Satuan::orderBy('nama_satuan','ASC')->get();
        return view('master_kegiatan/edit_dpa', compact('jenis_belanja', 'sumber_dana', 'metode_pelaksanaan', 'satuan','uuid'));
    }

    public function editTolakUkur($uuid)
    {
        $satuan = Satuan::orderBy('nama_satuan','ASC')->get();
        return view('master_kegiatan/atur_tolak_ukur_dpa', compact( 'satuan','uuid'));
    }
    ...
    public function paket_dak(){
        ...
        return view('master_kegiatan/dak', compact('jadwal_input'));
    }
