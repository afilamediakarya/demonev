    ...
    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
        ...
        <div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
            <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                <!--begin::Info-->
                <a href="{{ cekJadwal('Kegiatan','Sub Kegiatan Renstra Pokok') ? url('kegiatan/dpa/set-output') : '#'}}" class="btn btn-primary font-weight-bolder {{cekJadwal('Kegiatan','Sub Kegiatan Renstra Pokok') ? '' : 'disabled'}}">
                                ...
                                <table class="table table-bordered table-checkable" id="kt_datatable"
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th>GROUPING</th>
                                            <th>SUB KEGIATAN</th>
                                            <th>INDIKATOR PROGRAM (OUTCOME)</th>
                                            <th>NILAI PAGU (RP)</th>
                                            <th>AKSI</th>
                                        </tr>
                                    </thead>
    ...
    <script>
        $(document).ready(function () {
            var _mainTable = $('.table').DataTable({
                ...
                "ajax": {
                    url: '{{route('api.renstra.data-table',['tahun' => session('tahun_penganggaran')])}}',
                    type: "GET",
