...
@section('breadcrumb')
    ...
    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
        <li class="breadcrumb-item">
            <a href="{{url('kegiatan/dak')}}" class="">{{$label}}</a>
        </li>
        <li class="breadcrumb-item">
            <a href="" class="">Atur Perencanaan</a>
        </li>
    </ul>
@endsection
@section('style')
    ...
    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
        ...
        <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
            <div class="d-flex flex-column-fluid">
                ...
                <div class="container">
                    <!--begin::Card-->
                    <form id="paket-form" action="{{route('api.dak_non_fisik.create')}}" method="post">
                        {{csrf_field()}}
                                                    ...
                                                    <div class="card-header border-0 pb-0">
                                                        ...
                                                        <div class="card-toolbar">
                                                            ...
                                                            class="btn btn-text-dark-50 btn-icon-primary btn-hover-icon-danger font-weight-bold btn-hover-bg-light mr-3">
                                                                <i class="flaticon2-plus-1"></i>Tambah {{$label}}</a>
                                                        </div>
                                                    </div>
                    ...
                    if (result.isConfirmed) {
                        ...
                        axios.post(action, data)
                            .then(function () {
                                ...
                                if (label == 'Paket DAK - Non Fisik') {
                                    window.location.href = '{{route('kegiatan.dak_non_fisik')}}'    
                                } else if(label == 'Paket PEN') {
                                    window.location.href = '{{route('kegiatan.dak_pen')}}'
                                } else if(label == 'Paket APBN') {
                                    window.location.href = '{{route('kegiatan.dak_apbn')}}'
                                }
                                else if(label == 'Paket APBD I') {
                                    window.location.href = '{{route('kegiatan.dak_apbd1')}}'
                                }else{
                                    window.location.href = '{{route('kegiatan.dak_apbd2')}}'
                                }
