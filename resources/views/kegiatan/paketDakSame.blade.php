...
@push('script')
    <script>
        $(document).ready(function () {
            ...
            if (label == 'Paket PEN') {
                url = '{{route('api.pen.data-table',['tahun' => session('tahun_penganggaran'),'keyword'=>"PEN"])}}';
            }else if(label == 'Paket APBN'){
                url = '{{route('api.pen.data-table',['tahun' => session('tahun_penganggaran'),'keyword'=>"APBN"])}}';
            }else if(label == 'Paket APBD I'){
                url = '{{route('api.pen.data-table',['tahun' => session('tahun_penganggaran'),'keyword'=>"APBD I"])}}';
            }else{
                url = '{{route('api.pen.data-table',['tahun' => session('tahun_penganggaran'),'keyword'=>"APBD II"])}}';
            }
