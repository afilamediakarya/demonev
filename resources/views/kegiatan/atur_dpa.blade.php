                                                ...
                                                <div data-repeater-list="">
                                                    <div class="card-body py-0 row" data-repeater-item>
                                                        <div class="form-group col-12 col-lg-6">
                                                            ...
                                                            <textarea name="tolak_ukur" id="tolak_ukur_" readonly class="form-control"
...
@push('script')
    <script>
        $(document).ready(function () {
            ...
            axios.get('{{route('api.dpa.opsi.sub-kegiatan'). (isset($uuid) ? '?uuid='.$uuid.'&tahun='.$tahun : '?tahun='.$tahun)}}')
                .then(function (res) {
