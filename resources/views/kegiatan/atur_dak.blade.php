...
@section('breadcrumb')
    ...
    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
        <li class="breadcrumb-item">
            <a href="{{url('kegiatan/dak')}}" class="">Paket DAK</a>
        </li>
        <li class="breadcrumb-item">
            <a href="" class="">Atur Perencaan</a>
        </li>
    </ul>
@endsection
@section('style')
    ...
    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
        ...
        <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
            <div class="d-flex flex-column-fluid">
                ...
                <div class="container">
                    <!--begin::Card-->
                    <form id="paket-form" action="{{route('api.dak.create')}}" method="post">
                        {{csrf_field()}}
                        <input type="hidden" name="uuid" value="{{$uuid}}">
                        <input type="hidden" name="uuid_sd" value="{{$uuid_sd}}">
                        <input type="hidden" name="tahun" value="{{session('tahun_penganggaran')}}">
                        <input type="hidden" name="nilai_pagu_dak" value="{{$dpa->SumberDanaDpa->first()->nilai_pagu}}">
                            ...
                            <div class="card-body" style="padding-top:0">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="row">
                                            <div class="col-12">
                                                <div id="paket-dak" class="card card-custom border-0 card-fit"
                                                    style="box-shadow:none">
                                                    <div class="card-header border-0 pb-0">
                                                        <div class="card-title">
                                                            <h3 class="card-label">Paket DAK</h3>
                                                        </div>
                                                        <div class="card-toolbar">
                                                            <a href="javascript:;" data-repeater-create="" id="btn-tambah-paket-dak"
                                                            class="btn btn-text-dark-50 btn-icon-primary btn-hover-icon-danger font-weight-bold btn-hover-bg-light mr-3">
                                                                <i class="flaticon2-plus-1"></i>Tambah Paket DAK</a>
                                                        </div>
                                                    </div>
                                                    <div data-repeater-list="">
                                                        <div class="card-body py-0 row" data-repeater-item>

                                                        <div class="row col-12 col-lg-12 pr-0">
                                                        <input name="uuid" type="hidden"
                                                        class="form-control"
                                                        placeholder="" required>
                                                                <div class="col-11 col-lg-11 row p-0">
                                                                <div class="form-group col-12 col-lg-6">
                                                                        <label>Rincian Dak</label>
                                                                        <select class="form-control id_rincian" name="id_rincian" id="id_rincian">
                                                                        <option value="" selected disabled>Pilih Rincian Dak</option>
                                                                            @foreach($rincianDak as $rincan)
                                                                            <option value="{{$rincan->id}}">{{$rincan->kode_rincian}} - {{$rincan->rincian}}</option>
                                                                            @endforeach
                                                                        </select>
                                                                    </div>
                                                                    <div class="form-group col-12 col-lg-6">
                                                                    ...
                                                                    <div class="form-group col-12 col-lg-2">
                                                                        ...
                                                                        <input name="penerima_manfaat" type="number"
                                                                            min="0"
                                                                            class="form-control"
                                                                            placeholder="" required>
                                                                    </div>
                                                                    ...
                                                                    <div class="form-group col-12 col-lg-3">
                                                                        ...
                                                                        <input name="anggaran_dak" type="number"
                                                                            min="0"
                                                                            value="0"
                                                                            class="form-control"
                                                                            placeholder="" required>
                                                                    </div>
                                                                    <div class="form-group col-10 col-lg-2 hide">
                                                                        <label>Pendampingan(Rp)</label>
                                                                        <input name="pendampingan" type="number"
                                                                            min="0"
                                                                            value="0"
                                                                            class="form-control"
                                                                            placeholder="" required>
                                                                    ...
                                                                    <div class="form-group col-10 col-lg-2 hide">
                                                                        <label>Swakelola(Rp)</label>
                                                                        <input name="swakelola" type="number"
                                                                            min="0"
                                                                            value="0"
                                                                            class="form-control"
                                                                            placeholder="" required>
                                                                    ...
                                                                    {{--<div class="form-group col-10 col-lg-4">
                                                                        <label>Kontrak(Rp)</label>
                                                                        <input name="kontrak" type="number"
                                                                            min="0"
                                                                            value="0"
                                                                            class="form-control"
                                                                            placeholder="" required>
                                                                    ...
                                                                    <div class="form-group col-10 col-lg-3">
                                                                        ...
                                                                        <input name="total_biaya" type="number"
                                                                            min="0"
                                                                            class="form-control"
                                                                            value="0"
                                                                    ...
                                                                    <div class="form-group col-12 col-lg-6" style="display:none">
                                                                        ...
                                                                        <select name="kesesuaian_rkpd" class="form-control" required>
                                                                    ...
                                                                    <div class="form-group col-12 col-lg-6" style="display:none">
                                                                        ...
                                                                        <select name="kesesuaian_dpa_skpd" class="form-control" required>
                                                                            <!-- <option value="" selected disabled>Pilih</option> -->
                                                                            <option value="Y"selected >Ya</option>
                                                                            <option value="N">Tidak</option>
                                                                        </select>
...
<script>
    // $('.id_rincian').select2();
    $(document).on('mouseover', '.id_rincian', function() {
        ...
        $(document).ready(function () {
            ...
            var initFvPaketDak = function (index){
                ...
                fv.addField('['+index+'][id_rincian]', {
                    validators: {
                        notEmpty: {
                            message: 'rincian dak tidak boleh kosong'
                        }
                    }
                })
                ...
                fv.addField('['+index+'][penerima_manfaat]', {
                    validators: {
                        notEmpty: {
                            message: 'manfaat tidak boleh kosong'
                        }
                    }
                })
                fv.addField('['+index+'][anggaran_dak]', {
                    validators: {
                        notEmpty: {
                ...
                /*fv.addField('['+index+'][pendampingan]', {
                    validators: {
                        notEmpty: {
                            message: 'pendampingan tidak boleh kosong'
                        }
                    }
                })
                fv.addField('['+index+'][swakelola]', {
                    validators: {
                        notEmpty: {
                            message: 'swakelola tidak boleh kosong'
                        }
                    }
                })*/
                fv.addField('['+index+'][kesesuaian_rkpd]', {
                    validators: {
                        notEmpty: {
                            message: 'Kesesuaian Sasaran dan Lokasi dengan RKPD tidak boleh kosong'
                        }
                    }
                })

                fv.addField('['+index+'][kesesuaian_dpa_skpd]', {
                    validators: {
                        notEmpty: {
                            message: 'Kesesuaian Antara DPA SKPD dengan Petunjuk Teknis DAK tidak boleh kosong'
                        }
                    }
                })
            }
            ...
            axios.get('{{route('api.dak.find-paket',[$uuid_sd])}}')
            .then(function (res){
                ...
                res.data.response.paket_dak.forEach(function (val,i){
                    if (i > 0){
                        $('#btn-tambah-paket-dak').click();
                    }
                    for (var key in val){
                        if(key=='paket_dak_lokasi'){
                        ...
                        if ($('#paket-dak [name="['+i+']['+key+']"]').length)
                            $('#paket-dak [name="['+i+']['+key+']"]').val(val[key])
            ...
            $('#paket-dak').repeater({
                ...
                repeaters: [{
                    ...
                    show: function () {
                        $(this).slideDown();
                        var head = $('#paket-dak [data-repeater-item]').length - 1;
                ...
                show: function () {
                    $(this).slideDown();
                    var index = $('#paket-dak [data-repeater-item]').length - 1;
                ...
                hide: function (deleteElement) {
                    ...
                    fv.removeField('['+index+'][id_rincian]')
                    fv.removeField('['+index+'][volume]')
                    fv.removeField('['+index+'][satuan]')
                    fv.removeField('['+index+'][penerima_manfaat]')
                    fv.removeField('['+index+'][anggaran_dak]')
                    // fv.removeField('['+index+'][pendampingan]')
                    // fv.removeField('['+index+'][swakelola]')
                    // fv.removeField('['+index+'][kontrak]')
                    fv.removeField('['+index+'][total_biaya]')
                    fv.removeField('['+index+'][kesesuaian_rkpd]')
                    fv.removeField('['+index+'][kesesuaian_dpa_skpd]')
                    setTimeout(function (){
            ...
            $(document).on('keyup mouseup input', '[name*="[anggaran_dak]"],  [name*="[pendampingan]"]', function () {
                var ang = 0;
                var pen = 0;
                var swa = 0;
                var kon = 0;
                var total = 0;
                var anggaran = $('[name*="[anggaran_dak]');
                var nilai_pagu = $('[name*=nilai_pagu_dak]').val()
                ...
                document.getElementById('paket-form'),
                {
                    fields: {
                        ...
                        /*'[0][pendampingan]': {
                            validators: {
                                notEmpty: {
                                    message: 'pendampingan boleh kosong'
                                }
                            }
                        },
                        '[0][swakelola]': {
                            validators: {
                                notEmpty: {
                                    message: 'swakelola boleh kosong'
                                }
                            }
                        },*/
                        /*'[0][kontrak]': {
                        ...
                        //     validators: {
                        //         notEmpty: {
                        //             message: 'total biaya boleh kosong'
                        //         }
                        //     }
                        // },
            ...
            fv.on('core.form.valid', function () {
                ...
                if ($('[name=uuid]').val() != '') {
                    state = 'Update'
                    additional_info = '<br>Mengupdate Data DAK akan me-Reset data <b>Realisasi DAK</b>.';
                }
                Swal.fire({
                    title: 'Perhatian!!',
                    ...
                    if (result.isConfirmed) {
                        ...
                        var el_uuid_pd = $('#paket-dak [name*=uuid]');
                        ...
                        var el_id_rincian = $('[name*=id_rincian]');
                        el_id_rincian.each(function (i, el) {
                            data += '&id_rincian[' + i + ']=' + $(el).val()
                        })
                        ...
                        var el_penerima_manfaat = $('[name*=penerima_manfaat]');
                        el_penerima_manfaat.each(function (i, el) {
                            data += '&penerima_manfaat[' + i + ']=' + $(el).val()
                        })
                        var el_anggaran_dak = $('[name*=anggaran_dak]');
                        el_anggaran_dak.each(function (i, el) {
                            data += '&anggaran_dak[' + i + ']=' + $(el).val()
                        })
                        var el_pendampingan = $('[name*=pendampingan]');
                        el_pendampingan.each(function (i, el) {
                            data += '&pendampingan[' + i + ']=' + $(el).val()
                        })
                        var el_swakelola = $('[name*=swakelola]');
                        el_swakelola.each(function (i, el) {
                            data += '&swakelola[' + i + ']=' + $(el).val()
                        })
                        /*var el_kontrak = $('[name*=kontrak]');
                        el_kontrak.each(function (i, el) {
                            data += '&kontrak[' + i + ']=' + $(el).val()
                        })
                        var el_kecamatan = $('[name*=kecamatan]');
                        el_kecamatan.each(function (i, el) {
                            data += '&kecamatan[' + i + ']=' + $(el).val()
                        })
                        var el_desa = $('[name*=desa]');
                        el_desa.each(function (i, el) {
                            data += '&desa[' + i + ']=' + $(el).val()
                        })*/
                        var el_kesesuaian_rkpd = $('[name*=kesesuaian_rkpd]');
                        el_kesesuaian_rkpd.each(function (i, el) {
                            data += '&kesesuaian_rkpd[' + i + ']=' + $(el).val()
                        })
                        var el_kesesuaian_dpa_skpd = $('[name*=kesesuaian_dpa_skpd]');
                        el_kesesuaian_dpa_skpd.each(function (i, el) {
                            data += '&kesesuaian_dpa_skpd[' + i + ']=' + $(el).val()
                        })
                        console.log(data);
                        axios.post(action, data)
                            .then(function () {
                                Swal.fire('Sukses!', 'Berhasil Menyimpan Data Perencanaan', 'success')
                                window.location.href = '{{route('kegiatan.dak')}}'
                            })
                            .catch(function (err) {
