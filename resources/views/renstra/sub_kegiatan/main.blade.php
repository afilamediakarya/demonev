    ...
    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
        ...
        <div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
            <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                <!--begin::Info-->
                <a href="{{url('renstra/sub-kegiatan/set-output')}}" class="btn btn-primary font-weight-bolder">
    ...
    <script>
        $(document).ready(function () {
            var _mainTable = $('.table').DataTable({
                ...
                "ajax": {
                    url: '{{route('api.renstra-sub-kegiatan.data-table',['tahun' => session('tahun_penganggaran')])}}',
                    type: "GET",
            ...
            $('body').on('click', '.button-delete', function (e) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        axios.delete('{{route('api.renstra-sub-kegiatan')}}/uuid/' + uuid)
                            .then(function () {
