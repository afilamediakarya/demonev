                                                    ...
                                                    <select name="id_sub_kegiatan" id="id_sub_kegiatan" class="form-control" required>
                                                            <option value="" selected disabled>Pilih Sub Kegiatan</option>
                                                                @foreach($sub_kegiatans AS $s)
                                                                    <option value="{{$s->id}}">{{$s->nama_sub_kegiatan}}</option>
                                                                @endforeach
                                                    </select>
                                                </div>
                                                                    ...
                                                                    <table class="table">
                                                                        <thead>
                                                                            <tr>
                                                                                ...
                                                                                <th class="text-right">REALISASI KEUANGAN(Rp)</th>
                                                            ...
                                                            <div class="row px-5">
                                                                @for ($i=2019;$i<=2023;$i++)
                                                                    ...
                                                                    <div class="form-group col-6 col-lg-3">
                                                                        ...
                                                                        <select name="[{{$i}}][sb_sat]" class="form-control" required>
