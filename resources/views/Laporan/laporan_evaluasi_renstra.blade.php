...
@section('breadcrumb')
    ...
    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
        <li class="breadcrumb-item">
            <a href="" class="">Evaluasi Renstra</a>
        </li>
    </ul>
@endsection
<!-- 37751550 cph2380 -->
                        ...
                        <div class="card card-custom card-stretch example example-compact" id="kt_page_stretched_card">
                            <div class="card-header d-flex flex-column" kt-hidden-height="74" style="">
                                <div class="card-title my-7">
                                    <h3 class="card-label">Laporan Evaluasi Renstra</h3>
                                </div>
                                <form id="laporan-form" style="background-color:#f6f9ff" class="py-5 rounded mb-5">
                                    <div class="row">
                                            ...
                                            <div class="row px-5">
                                                <div class="col-md col-sm-12">
                                                    <div class="form-group">
                                                        <label for="">Periode Anggaran</label>
                                                        <select name="periode" class="form-control" required>
                                                            <option value="" selected disabled>Pilih Periode Anggaran</option>
                                                            
                                                            <option value="x" >Periode Anggaran 2018-2023</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="col-md col-sm-12">
                                        ...
                                        <div class="col-12 d-flex">
                                            <div class="px-5">
                                                <a id="export-excel" href="{{url('laporan/export_evaluasi_renstra/excel')}}" class="btn btn-success btn-xs m-1 ">
                                                    <i class="fas fa-file-excel"></i> Export Excel
                                                </a>
                                                <a id="export-pdf" href="{{url('laporan/export_evaluasi_renstra/pdf')}}" class="btn btn-danger btn-xs m-1">
