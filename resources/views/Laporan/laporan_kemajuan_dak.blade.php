                        ...
                        <div class="card card-custom card-stretch example example-compact" id="kt_page_stretched_card">
                            <div class="card-header d-flex flex-column" kt-hidden-height="74" style="">
                                <div class="card-title my-7">
                                    <h3 class="card-label">Laporan KEMAJUAN DAK</h3>
                                </div>
                                <form id="laporan-form" style="background-color:#f6f9ff" class="py-5 rounded mb-5">
                                    <div class="row">
                                            ...
                                            <div class="row px-5">
                                                ...
                                                <div class="col-md col-sm-12">
                                                    <div class="form-group">
                                                        ...
                                                        <select name="sumber_dana" id="sumber-dana" class="form-control">
                                                            <option value="DAK">Semua</option>
                                        ...
                                        <div class="col-12 d-flex">
                                            <div class="px-5">
                                                <a id="export-excel" href="javascript:;" class="btn btn-success btn-xs m-1 ">
                                                    <i class="fas fa-file-excel"></i> Export Excel
                                                </a>
                                                <a id="export-pdf" href="javascript:;" class="btn btn-danger btn-xs m-1">
...
@push('script')
    <script>
        ...
        $('#export-pdf').click(function(e){
            e.preventDefault();
            let sumber_dana = $('#sumber-dana').val();
            let url = '';
            let param = $('#laporan-form').serialize();
            let periode = $('[name=periode]');
            
            if (sumber_dana == 'DAK FISIK') {
                url = '{{url('laporan/export_kemajuan_dak/pdf')}}'; 
            }else if(sumber_dana == 'DAK NON-FISIK'){
                url = '{{url('laporan/export_paket_dau/pdf')}}';
            }else{
                url = '{{url('laporan/export_paket_dau/pdf')}}';
            }
        ...
        $('#export-excel').click(function(e){
            ...
            if (sumber_dana == 'DAK FISIK') {
                url = '{{url('laporan/export_kemajuan_dak/excel')}}'; 
            }else if(sumber_dana == 'DAK NON-FISIK'){
                url = '{{url('laporan/export_paket_dau/excel')}}';
            }else{
                url = '{{url('laporan/export_paket_dau/excel')}}';
            }
