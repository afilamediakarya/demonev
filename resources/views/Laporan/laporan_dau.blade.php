                        ...
                        <div class="card card-custom card-stretch example example-compact" id="kt_page_stretched_card">
                            <div class="card-header d-flex flex-column" kt-hidden-height="74" style="">
                                <div class="card-title my-7">
                                    <h3 class="card-label">Laporan Paket DAU</h3>
                                </div>
                                <form id="laporan-form" style="background-color:#f6f9ff" class="py-5 rounded mb-5">
                                    <div class="row">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select name="sumber_dana" class="form-control">
                                                            ...
                                                            @foreach($sumber_dana AS $sd)
                                                               <option value="{{$sd->nama_sumber_dana}}" {{$sumber_dana_selected == $sd->nama_sumber_dana ? 'selected' : ''}}>{{$sd->nama_sumber_dana}}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="col-12 d-flex">
                                            <div class="px-5">
                                                <a id="export-excel" href="{{url('laporan/export_paket_dau/excel')}}" class="btn btn-success btn-xs m-1 ">
                                                    <i class="fas fa-file-excel"></i> Export Excel
                                                </a>
                                                <a id="export-pdf" href="{{url('laporan/export_paket_dau/pdf')}}" class="btn btn-danger btn-xs m-1">
