                        ...
                        <div class="card card-custom card-stretch example example-compact" id="kt_page_stretched_card">
                            <div class="card-header d-flex flex-column" kt-hidden-height="74" style="">
                                <div class="card-title my-7">
                                    <h3 class="card-label">Laporan Anggaran</h3>
                                </div>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered" id="kt_datatable"> 
                                        ...
                                        <tr>
                                            <td rowspan="3">1</td>
                                            <td>5.01</td>
                                            <td style="white-space: normal">Program Koordinasi Dan Sinkronisasi Perencanaan Pembangunan Daerah</td>
                                            <td></td>
                                            <td></td>
                                            <td></td>
                                            <td></td>
