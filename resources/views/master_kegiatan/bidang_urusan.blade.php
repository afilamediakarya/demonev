    ...
    <script>
        $(document).ready(function () {
            ...
            var _mainTable = $('.table').DataTable({
                ...
                "ajax": {
                    url: '{{route('api.bidang-urusan.data-table',['tahun' => session('tahun_penganggaran')])}}',
                    type: "GET",
                    headers: {'X-XSRF-TOKEN': Cookies.get("XSRF-TOKEN")},
                },
                columns: [
                    {data: 'kode_bidang_urusan', name: 'kode_bidang_urusan'},
                    {data: 'urusan', name: 'urusan', orderable: false, visible: false},
                    {data: 'nama_bidang_urusan', name: 'nama_bidang_urusan'},
            ...
            $('body').on('click', '.open-panel', function (e) {
                ...
                axios.get('{{route('api.bidang-urusan')}}/uuid/' + uuid)
                    .then(function (res) {
            ...
            $('body').on('click', '.button-delete', function (e) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        var uuid = $(this).data('uuid')
                        axios.delete('{{route('api.bidang-urusan')}}/uuid/' + uuid)
                            .then(function () {
                                _mainTable.ajax.reload();
                                Swal.fire('Sukses!', 'Berhasil Menghapus Bidang Urusan', 'success')
                            })
                            .catch(function () {
                ...
                document.getElementById('data-form'),
                {
                    fields: {
                        nama_urusan: {
                            validators: {
                                notEmpty: {
                                    message: 'Nama Bidang Urusan tidak boleh kosong'
                                }
                            }
                        },
                        kode_urusan: {
                            validators: {
                                notEmpty: {
                                    message: 'Kode Bidang Urusan tidak boleh kosong'
                                }
                            }
                        },
                    },
                    ...
                    if (result.isConfirmed) {
                        ...
                        axios.post(action, $('#data-form').serialize())
                            .then(function () {
                                _mainTable.ajax.reload();
                                _sidePanel.hide();
                                Swal.fire('Sukses!', 'Berhasil Menyimpan Data Bidang Urusan', 'success')
                            })
                            .catch(function (err) {
