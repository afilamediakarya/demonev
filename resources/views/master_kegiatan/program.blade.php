...
@section('side_form')
    <div id="side_panel" class="offcanvas offcanvas-right p-10">
        ...
        <div class="offcanvas-content">
            <!--begin::Wrapper-->
            <form id="data-form" action="{{route('api.program.create')}}" method="post">
                ...
                <div class="offcanvas-wrapper mb-5 scroll-pull">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="nama_program" class="form-control"  rows="3"
                                  required></textarea>
                    </div>
                    <div class="form-group">
                        ...
                        <textarea name="capaian_program" class="form-control"  rows="3"
                                  required></textarea>
                    </div>
                    <div class="form-group">
                        <label> Kode Program
                        ...
                        <input name="kode_program" type="text" class="form-control" placeholder="Enter Kode Program"
                               required>
                    </div>
                </div>
                <!--end::Wrapper-->
    ...
    <script>
        $(document).ready(function () {
            ...
            var _mainTable = $('.table').DataTable({
                ...
                "ajax": {
                    url: '{{route('api.program.data-table',['tahun' => session('tahun_penganggaran')])}}',
                    type: "GET",
            ...
            var getBidangUrusan = function (urusan, _bidang_urusan) {
            ...
            $('body').on('click', '.open-panel', function (e) {
                ...
                axios.get('{{route('api.program')}}/uuid/' + uuid)
                    .then(function (res) {
                        ...
                        $('[name=id_urusan]').select2()
                        getBidangUrusan(res.data.response.id_urusan, res.data.response.id_bidang_urusan)
                    })
                _sidePanel.show();
            })
            $('body').on('click', '.button-delete', function (e) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        var uuid = $(this).data('uuid')
                        axios.delete('{{route('api.program')}}/uuid/' + uuid)
                            .then(function () {
                ...
                document.getElementById('data-form'),
                {
                    fields: {
                        ...
                        capaian_program: {
                            validators: {
                                notEmpty: {
                                    message: 'Capaian Program tidak boleh kosong'
                                }
                            }
                        },
                        kode_program: {
