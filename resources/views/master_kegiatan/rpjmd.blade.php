    ...
    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
        ...
        <div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
            <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                <!--begin::Info-->
                <a href="{{ cekJadwal('Kegiatan','Sub Kegiatan RPJMD Pokok') ? url('kegiatan/dpa/set-output') : '#'}}" class="btn btn-primary font-weight-bolder {{cekJadwal('Kegiatan','Sub Kegiatan RPJMD Pokok') ? '' : 'disabled'}}">
    ...
    <script>
        $(document).ready(function () {
            var _mainTable = $('.table').DataTable({
                ...
                "ajax": {
                    url: '{{route('api.rpjmd.data-table',['tahun' => session('tahun_penganggaran')])}}',
                    type: "GET",
