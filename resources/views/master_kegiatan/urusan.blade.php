...
@section('side_form')
    <div id="side_panel" class="offcanvas offcanvas-right p-10">
        ...
        <div class="offcanvas-content">
            <!--begin::Wrapper-->
            <form id="data-form" action="{{route('api.urusan.create')}}" method="post">
                ...
                <div class="offcanvas-wrapper mb-5 scroll-pull">
                    <div class="form-group">
                        ...
                        <textarea name="nama_urusan" class="form-control" id="exampleTextarea" rows="3"
                                  required></textarea>
                    </div>
                    <div class="form-group">
                        <label>Kode Urusan
                            <span class="text-danger">*</span></label>
                        <input name="kode_urusan" type="text" class="form-control" placeholder="Enter Kode Urusan"
                               required/>
                    </div>
                </div>
                <!--end::Wrapper-->
    ...
    <script>
        $(document).ready(function () {
            ...
            var _mainTable = $('.table').DataTable({
                ...
                "ajax": {
                    url: '{{route('api.urusan.data-table')}}',
                    type: "GET",
            ...
            $('body').on('click', '.open-panel', function (e) {
                ...
                axios.get('{{route('api.urusan')}}/uuid/' + uuid)
                    .then(function (res) {
            ...
            $('body').on('click', '.button-delete', function (e) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        var uuid = $(this).data('uuid')
                        axios.delete('{{route('api.urusan')}}/uuid/' + uuid)
                            .then(function () {
                                _mainTable.ajax.reload();
                                Swal.fire('Sukses!', 'Berhasil Menghapus Urusan', 'success')
                            })
                            .catch(function () {
                ...
                document.getElementById('data-form'),
                {
                    fields: {
                        nama_urusan: {
                            validators: {
                                notEmpty: {
                                    message: 'Nama Urusan tidak boleh kosong'
                                }
                            }
                        },
                        kode_urusan: {
                            validators: {
                                notEmpty: {
                                    message: 'Kode Urusan tidak boleh kosong'
                                }
                            }
                        },
                    },
                    ...
                    if (result.isConfirmed) {
                        ...
                        axios.post(action, $('#data-form').serialize())
                            .then(function () {
                                _mainTable.ajax.reload();
                                _sidePanel.hide();
                                Swal.fire('Sukses!', 'Berhasil Menyimpan Data Urusan', 'success')
                            })
                            .catch(function (err) {
