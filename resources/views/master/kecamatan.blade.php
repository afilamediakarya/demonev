...
@section('side_form')
    <div id="side_panel" class="offcanvas offcanvas-right p-10">
        ...
        <div class="offcanvas-header d-flex align-items-center justify-content-between pb-7">
            <h4 class="font-weight-bold m-0">Tambah Kecamatan</h4>
        ...
        <div class="offcanvas-content">
            <!--begin::Wrapper-->
            <form id="data-form" action="{{route('api.kecamatan.create')}}" method="post">
                ...
                <div class="offcanvas-wrapper mb-5 scroll-pull">
                    <div class="form-group">
                        ...
                        <input name="nama" type="text" class="form-control"
                               placeholder="Enter Kecamatan" autocomplete="off" required/>
                    </div>
                </div>
                <!--end::Wrapper-->
                <!--begin::Purchase-->
    ...
    <script>
        $(document).ready(function () {
            ...
            var _mainTable = $('.table').DataTable({
                ...
                "ajax": {
                    url: '{{route('api.kecamatan.data-table')}}',
                    type: "GET",
            ...
            $('body').on('click', '.open-panel', function (e) {
                ...
                axios.get('{{route('api.kecamatan')}}/uuid/' + uuid)
                    .then(function (res) {
            ...
            $('body').on('click', '.button-delete', function (e) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        var uuid = $(this).data('uuid')
                        axios.delete('{{route('api.kecamatan')}}/uuid/' + uuid)
                            .then(function () {
                                _mainTable.ajax.reload();
                                Swal.fire('Sukses!', 'Berhasil Menghapus Kecamatan', 'success')
                            })
                            .catch(function () {
                    ...
                    if (result.isConfirmed) {
                        ...
                        axios.post(action, $('#data-form').serialize())
                            .then(function () {
                                _mainTable.ajax.reload();
                                _sidePanel.hide();
                                Swal.fire('Sukses!', 'Berhasil Menyimpan Data Kecamatan', 'success')
                            })
                            .catch(function (err) {
