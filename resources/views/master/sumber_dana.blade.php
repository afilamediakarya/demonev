...
@section('side_form')
    <div id="side_panel" class="offcanvas offcanvas-right p-10">
        ...
        <div class="offcanvas-header d-flex align-items-center justify-content-between pb-7">
            <h4 class="font-weight-bold m-0">Tambah Sumber Dana</h4>
        ...
        <div class="offcanvas-content">
            <!--begin::Wrapper-->
            <form id="data-form" action="{{route('api.sumber-dana.create')}}" method="post">
                ...
                <div class="offcanvas-wrapper mb-5 scroll-pull">
                    ...
                    <div class="form-group">
                        <label>Nama Sumber Dana
                            <span class="text-danger">*</span></label>
                        <input name="nama_sumber_dana" type="text" class="form-control"
                               placeholder="Enter Nama Sumber Dana" autocomplete="off" required/>
                    </div>
                </div>
                <!--end::Wrapper-->
                <!--begin::Purchase-->
    ...
    <script>
        $(document).ready(function () {
            ...
            var _mainTable = $('.table').DataTable({
                ...
                "ajax": {
                    url: '{{route('api.sumber-dana.data-table')}}',
                    type: "GET",
                    headers: {'X-XSRF-TOKEN': Cookies.get("XSRF-TOKEN")},
                },
                columns: [
                    {data: 'kode', name: 'kode'},
                    {data: 'nama_sumber_dana', name: 'nama_sumber_dana'},
            ...
            $('body').on('click', '.open-panel', function (e) {
                ...
                axios.get('{{route('api.sumber-dana')}}/uuid/' + uuid)
                    .then(function (res) {
            ...
            $('body').on('click', '.button-delete', function (e) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        var uuid = $(this).data('uuid')
                        axios.delete('{{route('api.sumber-dana')}}/uuid/' + uuid)
                            .then(function () {
                                _mainTable.ajax.reload();
                                Swal.fire('Sukses!', 'Berhasil Menghapus Sumber Dana', 'success')
                            })
                            .catch(function () {
                ...
                document.getElementById('data-form'),
                {
                    fields: {
                        ...
                        nama_sumber_dana: {
                            validators: {
                                notEmpty: {
                                    message: 'Nama Sumber Dana tidak boleh kosong'
                                }
                            }
                        },
                    },
                    ...
                    if (result.isConfirmed) {
                        ...
                        axios.post(action, $('#data-form').serialize())
                            .then(function () {
                                _mainTable.ajax.reload();
                                _sidePanel.hide();
                                Swal.fire('Sukses!', 'Berhasil Menyimpan Data Sumber Dana', 'success')
                            })
                            .catch(function (err) {
