...
@section('side_form')
    <div id="side_panel" class="offcanvas offcanvas-right p-10">
        ...
        <div class="offcanvas-header d-flex align-items-center justify-content-between pb-7">
            <h4 class="font-weight-bold m-0">Tambah Jenis Belanja</h4>
        ...
        <div class="offcanvas-content">
            <!--begin::Wrapper-->
            <form id="data-form" action="{{route('api.jenis-belanja.create')}}" method="post">
                ...
                <div class="offcanvas-wrapper mb-5 scroll-pull">
                    ...
                    <div class="form-group">
                        <label>Nama Jenis Belanja
                            <span class="text-danger">*</span></label>
                        <input name="nama_jenis_belanja" type="text" class="form-control"
                               placeholder="Enter Jenis Belanja" autocomplete="off" required/>
                    </div>
                </div>
                <!--end::Wrapper-->
                <!--begin::Purchase-->
    ...
    <script>
        $(document).ready(function () {
            ...
            var _mainTable = $('.table').DataTable({
                ...
                "ajax": {
                    url: '{{route('api.jenis-belanja.data-table')}}',
                    type: "GET",
            ...
            $('body').on('click', '.open-panel', function (e) {
                ...
                axios.get('{{route('api.jenis-belanja')}}/uuid/' + uuid)
                    .then(function (res) {
            ...
            $('body').on('click', '.button-delete', function (e) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        var uuid = $(this).data('uuid')
                        axios.delete('{{route('api.jenis-belanja')}}/uuid/' + uuid)
                            .then(function () {
                                _mainTable.ajax.reload();
                                Swal.fire('Sukses!', 'Berhasil Menghapus Jenis Belanja', 'success')
                            })
                            .catch(function () {
                ...
                document.getElementById('data-form'),
                {
                    fields: {
                        ...
                        nama_jenis_belanja: {
                            validators: {
                                notEmpty: {
                                    message: 'Nama Jenis Belanja tidak boleh kosong'
                                }
                            }
                        },
                    },
                    ...
                    if (result.isConfirmed) {
                        ...
                        axios.post(action, $('#data-form').serialize())
                            .then(function () {
                                _mainTable.ajax.reload();
                                _sidePanel.hide();
                                Swal.fire('Sukses!', 'Berhasil Menyimpan Data Jenis Belanja', 'success')
                            })
                            .catch(function (err) {
