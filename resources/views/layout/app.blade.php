...
<head>
    <base href="">
    <meta charset="utf-8"/>
    <title>@yield('title') | E-Monev Enrekang</title>
    <meta name="description"
          content="Website Monitoring dan Evaluasi Kabupaten Enrekang"/>
    ...
    <link href="{{ asset('assets/css/themes/layout/custom.css')}}" rel="stylesheet" type="text/css"/>
    <!--end::Layout Themes-->
...
<div id="kt_header_mobile" class="header-mobile align-items-center header-mobile-fixed">
    <!--begin::Logo-->
    <a href="index.html">
        <img alt="Logo" style="height:32px" src="{{ asset('assets/media/logos/logo.svg')}}"/>
    </a>
    <!--end::Logo-->
    <!--begin::Toolbar-->
...
<script src="{{ asset('assets/plugins/polyfiller.js')}}"></script>
