...
@section('side_form')
    <div id="side_panel" class="offcanvas offcanvas-right p-10">
        ...
        <div class="offcanvas-header d-flex align-items-center justify-content-between pb-7">
            <h4 class="font-weight-bold m-0">Tambah Akses</h4>
        ...
        <div class="offcanvas-content">
            <!--begin::Wrapper-->
            <form id="data-form" action="{{route('api.akses.create')}}" method="post">
                <input type="hidden" name="uuid">
                <div class="offcanvas-wrapper mb-5 scroll-pull">
                    <div class="form-group">
                        <label>Nama Akses
                            <span class="text-danger">*</span></label>
                        <input name="nama_akses" type="text" class="form-control" placeholder="Enter email"/>
                    </div>
                    <div class="form-group">
                        <label>Link Url</label>
                        <div class="form-group row">
                            <label class="col-6 col-form-label pr-0" style="font-size:11px">{{url('')}}/</label>
                            <div class="col-6 pl-0">
                                <input name="route" class="form-control" type="text" value="" id="example-text-input"
                                       disabled>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        $(document).ready(function () {
            ...
            var _mainTable = $('.table').DataTable({
                ...
                "ajax": {
                    url: '{{route('api.akses.data-table')}}',
                    type: "GET",
                    headers: {'X-XSRF-TOKEN': Cookies.get("XSRF-TOKEN")},
                },
                columns: [
                    {data: 'nama_akses', name: 'nama_akses'},
            ...
            $('body').on('click', '.open-panel', function (e) {
                ...
                axios.get('{{route('api.akses')}}/uuid/' + uuid)
                    .then(function (res) {
