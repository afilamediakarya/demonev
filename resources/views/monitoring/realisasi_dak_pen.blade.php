...
@push('script')
    <script>
        $(document).ready(function () {
            ...
            if (label == 'Realisasi PEN') {
                url = '{{route('api.dakSame.data-table',['tahun' => session('tahun_penganggaran'),'keyword'=>"PEN"])}}';
            }else if(label == 'Realisasi APBN'){
                url = '{{route('api.dakSame.data-table',['tahun' => session('tahun_penganggaran'),'keyword'=>"APBN"])}}';
            }else if(label == 'Realisasi APBD I'){
                url = '{{route('api.dakSame.data-table',['tahun' => session('tahun_penganggaran'),'keyword'=>"APBD I"])}}';
            }else{
                url = '{{route('api.dakSame.data-table',['tahun' => session('tahun_penganggaran'),'keyword'=>"APBD II"])}}';
            }
