                    ...
                    <div class="card card-custom card-fit card-border">
                        <div class="card-header">
                            <div class="card-title">
                                <h3 class="card-label">Detail Kegiatans</h3>
                            </div>
                        </div>
                                                                ...
                                                                <div class="card-body pt-5 px-2 py-0">
                                                                    ...
                                                                    @endphp
                                                                           ...
                                                                           <div class="form-group col-3 volume_kontrak_content_{{$paket_dak->id}}">
                                                                                <label style="font-size:0.8rem">Volume Kontrak (K)</label>
                                                                                <input
                                                                            ...
                                                                            <div class="form-group col-3 volume_swakelola_content_{{$paket_dak->id}}">
                                                                                <label style="font-size:0.8rem">Volume Swakelola (K)</label>
                                                                                <input
                                                                                    value="{{optional($paket_dak)->volume_swakelola}}"
                                                                                    type="number" data-index="{{$paket_dak->id}}" style="width:100%" name="volume_swakelola[{{$target->periode}}][{{$paket_dak->id}}]" data-label="volume_swakelola{{$paket_dak->id}}" class="form-control  volume_swakelola{{$paket_dak->id}}"
                                                                                    placeholder="" {{!$periode[$target->periode] ? 'disabled' : ''}}>
                                                                            </div>

                                                                            <div class="form-group col-3 swakelola_content_{{$paket_dak->id}}">
                                                                            ...
                                                                            <div class="form-group col-3">
                                                                                <label style="font-size:0.8rem">Realisasi
                                                                                    Kinerja Triwulan {{integerToRoman($target->periode)}} (K) </label>
                                                                                <input
                                                                            ...
                                                                            <div class="form-group col-3">
                                                                                <label style="font-size:0.8rem">Permasalahan </br> <b>{{$paket_dak->nama_paket}}</b></label>
                                                                            ...
                                                                            <div class="form-group col-3">
                                                                                <label style="font-size:0.8rem">Realisasi
                                                                                    Kinerja Paket (K) </br> <b>{{$paket_dak->nama_paket}}</b></label>
                                                                                <input
                                                                            ...
                                                                            <div class="form-group col-3">
                                                                                <label style="font-size:0.8rem">Realisasi
                                                                                    Fisik (%) </br> <b>{{$paket_dak->nama_paket}}</b></label>
                                                                                <input
                                                                            ...
                                                                            <div class="form-group col-3">
                                                                                <label style="font-size:0.8rem">
                                                                                    Realisasi Keuangan Paket (Rp) </br> <b>{{$paket_dak->nama_paket}}</b></label>
                                                                                <input
                                                            ...
                                                            <div class="card card-custom  mt-5"
                                                                ...
                                                                <div class="card-body pt-5 px-2 py-0">
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="form-group col-6 col-lg-3">
                                                                            <label style="font-size:0.8rem">Realisasi
                                                                                Kinerja Sampai Saat Ini (K)</label>
                                                                            <input type="number" class="form-control"
...
@push('script')
    <script>
        ...
        $(document).ready(function () {
            ...
            // $('.radio_kontrak_control').prop("checked", true).trigger('change');
            // $('.nilai_kontrak_content').hide();
            // $('.volume_kontrak_content').hide();
            ...
            // $(document).on('click','[name*=type_radio][data-index]',function () {
            
            //     let value = $(this).val();
            //     let attr = $(this).attr('data-index');
            //     if (value == 'Kontrak') {
            //           $('.kontrak__').show();
            //           $('.swakelola__').attr('hidden','true');
            //           $('.kontrak__').removeAttr("hidden");
            ...
            //     } else if (value == 'Swakelola'){
            //         $('.swakelola__').show();
            //           $('.kontrak__').attr('hidden','true');
                      
            //           $('.swakelola__').removeAttr("hidden");
