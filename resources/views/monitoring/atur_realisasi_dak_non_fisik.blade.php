                    ...
                    if (result.isConfirmed) {
                        ...
                        axios.post(action, data)
                            .then(function () {
                                ...
                                if (label == 'Realisasi DAK Non Fisik') {
                                    window.location.href = '{{route('index.realisasi-dak-non-fisik')}}'    
                                } else if(label == 'Realisasi PEN') {
                                    window.location.href = '{{route('index.realisasi-dak-pen')}}'
                                } else if(label == 'Realisasi APBN') {
                                    window.location.href = '{{route('index.realisasi-dak-apbn')}}'
                                }
                                else if(label == 'Realisasi APBD I') {
                                    window.location.href = '{{route('index.realisasi-dak-apbd1')}}'
                                }else{
                                    window.location.href = '{{route('index.realisasi-dak-apbd2')}}'
                                }
