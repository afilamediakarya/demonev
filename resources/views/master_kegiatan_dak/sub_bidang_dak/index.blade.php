...
@section('side_form')
    <div id="side_panel" class="offcanvas offcanvas-right p-10">
        ...
        <div class="offcanvas-header d-flex align-items-center justify-content-between pb-7">
            <h4 class="font-weight-bold m-0">Tambah Sub Bidang Dak</h4>
        ...
        <div class="offcanvas-content">
            <!--begin::Wrapper-->
            <form id="data-form" action="{{route('api.subbidangdak.create')}}" method="post">
                <input type="hidden" name="uuid">
                <input type="hidden" name="tahun" value="">
                <div class="offcanvas-wrapper mb-5 scroll-pull">
                    <div class="form-group">
                        <label for="exampleSelect1">Pilih Bidang Dak
                            <span class="text-danger">*</span></label>
                        <select name="id_bidang_dak" class="form-control" id="exampleSelect1">

                        </select>
                    </div>
                    <div class="form-group">
                        <label>Nama Sub Bidang Dak
                            <span class="text-danger">*</span>
                        </label>
                        <textarea name="sub_bidang" class="form-control" id="exampleTextarea" rows="3"
                                  required></textarea>
                    </div>
                    <div class="form-group">
                        <label> Kode Sub Bidang Dak
                            <span class="text-danger">*</span>
                        </label>
                        <input name="kode_sub_bidang_dak" type="text" class="form-control"
    ...
    <script>
        $(document).ready(function () {
            ...
            var _mainTable = $('.table').DataTable({
                ...
                "ajax": {
                    url: '{{route('api.subbidangdak.data-table')}}',
                    type: "GET",
                    headers: {'X-XSRF-TOKEN': Cookies.get("XSRF-TOKEN")},
                },
                columns: [
                    {data: 'kode_sub_bidang_dak', name: 'kode_sub_bidang_dak'},
                    {data: 'bidang_dak', name: 'bidang_dak', orderable: false, visible: false},
            ...
            axios.get('{{route('api.bidangdak')}}')
                .then(function (res) {
                    var urusan = res.data.response.map(function (value) {
                        return '<option value="' + value.id + '">' + value.kode_bidang_dak + ' - ' + value.bidang + '</option>'
                    })
                    $('[name=id_bidang_dak]').append('<option value="" selected disabled>Pilih Bidang Dak</option>' + urusan.join(''))
                    $('[name=id_bidang_dak]').select2();
                })
            ...
            $('body').on('click', '.open-panel', function (e) {
                ...
                axios.get('{{route('api.subbidangdak')}}/uuid/' + uuid)
                    .then(function (res) {
                        console.log(res);
            ...
            $('body').on('click', '.button-delete', function (e) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        var uuid = $(this).data('uuid')
                        axios.delete('{{route('api.subbidangdak')}}/uuid/' + uuid)
                            .then(function () {
