...
@section('side_form')
    <div id="side_panel" class="offcanvas offcanvas-right p-10">
        ...
        <div class="offcanvas-header d-flex align-items-center justify-content-between pb-7">
            <h4 class="font-weight-bold m-0">Tambah Bidang Dak</h4>
        ...
        <div class="offcanvas-content">
            <!--begin::Wrapper-->
            <form id="data-form" action="{{route('api.tematikdak.create')}}" method="post">
                ...
                <div class="offcanvas-wrapper mb-5 scroll-pull">
                    <div class="form-group">
                        <label>Nama Tematik
                            ...
                            <input name="tematik" class="form-control"
                                  required/>
                    ...
                    <div class="form-group">
                        <label>Kode
                            <span class="text-danger">*</span></label>
                        <input name="kode_tematik" type="text" class="form-control" placeholder="Enter Kode "
                               required/>
                    </div>
                </div>
                <!--end::Wrapper-->
    ...
    <script>
        $(document).ready(function () {
            ...
            var _mainTable = $('.table').DataTable({
                ...
                "ajax": {
                    url: '{{route('api.tematikdak.data-table')}}',
                    type: "GET",
                    headers: {'X-XSRF-TOKEN': Cookies.get("XSRF-TOKEN")},
                },
                columns: [
                    {data: 'kode_tematik', name: 'kode_tematik'},
            ...
            $('body').on('click', '.open-panel', function (e) {
                ...
                axios.get('{{route('api.tematikdak')}}/uuid/' + uuid)
                    .then(function (res) {
            ...
            $('body').on('click', '.button-delete', function (e) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        var uuid = $(this).data('uuid')
                        axios.delete('{{route('api.tematikdak')}}/uuid/' + uuid)
                            .then(function () {
                                _mainTable.ajax.reload();
                                Swal.fire('Sukses!', 'Berhasil Menghapus Tematik Dak', 'success')
                            })
                            .catch(function () {
                ...
                document.getElementById('data-form'),
                {
                    fields: {
                        tematik: {
                            validators: {
                                notEmpty: {
                                    message: 'Nama Tematk tidak boleh kosong'
                                }
                            }
                        },
                        kode_tematik: {
                    ...
                    if (result.isConfirmed) {
                        ...
                        axios.post(action, $('#data-form').serialize())
                            .then(function () {
                                _mainTable.ajax.reload();
                                _sidePanel.hide();
                                Swal.fire('Sukses!', 'Berhasil Menyimpan Data Tematik Dak', 'success')
                            })
                            .catch(function (err) {
